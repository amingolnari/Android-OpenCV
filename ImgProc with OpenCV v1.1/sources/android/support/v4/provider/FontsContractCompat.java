            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                try {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        result2.add(new FontInfo(fileUri, ttcIndex, weightColumnIndex != -1 ? cursor.getInt(weightColumnIndex) : Highgui.CV_CAP_PROP_XI_DOWNSAMPLING, italicColumnIndex != -1 && cursor.getInt(italicColumnIndex) == 1, resultCode));
                    }
                    result = result2;
                } catch (Throwable th) {
                    th = th;
